...
tokenizer_path = "../../results/models/smallerVGG-short/tokenizer.pickle"
model_path = "../../results/models/smallerVGG-short/model.h5"
output_dir = "../../results/models/smallerVGG-short/"
